              ...
              "filter": {
                "bool": {
                  "must_not": [
                    ...
                    {
                      "match_phrase": {
                        "m.result": "300-提交问题:[41]输入信息中含有不符合法律法规的内容"
                      }
                    },
                    {
                      "match_phrase": {
                        "m.result": "300-提交问题:timeout"
                      }
                    },
                    {
                      "match_phrase": {
                        "m.result": "5405-您的出价不在播主接受范围~"
                      }
                    },
                    {
                      "match_phrase": {
                        "m.result": "300-提交问题:Failed to connect to hongrenshuo.com.cn/60.205.109.107:443"
                      }
                    },
                    {
                      "match_phrase": {
                        "m.result": "300-提交问题:failed to connect to hongrenshuo.com.cn/60.205.109.107 (port 443) after 30000ms"
                      }
                    }
                  ],
                  "must": [
