              ...
              "filter": {
                "bool": {
                  "must_not": [
                    {
                      "match_phrase": {
                        "m.result": "6013-sdk+not+initialized+or+not+logged+in."
                      }
                    },
                    {
                      "match_phrase": {
                    ...
                    {
                      "match_phrase": {
                        "m.result": "6012-failed"
                      }
                    },
                    {
                      "match_phrase": {
                        "m.result": "10025-failed"
                      }
                    },
                    {
                      "match_phrase": {
                        "m.result": "10010-failed"
                      }
                    },
                    {
                      "match_phrase": {
